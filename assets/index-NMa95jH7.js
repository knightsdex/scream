 ...
 */ (function (e) {
      ...
      e: for (var W = 0, J = _.length, er = J >>> 1; W < er;) {
        ...
        if (0 > l(wl, z))
          wn < J && 0 > l(nr, wl)
            ? ((_[W] = nr), (_[wn] = z), (W = wn))
            : ((_[W] = wl), (_[yn] = z), (W = yn));
        else if (wn < J && 0 > l(nr, z)) (_[W] = nr), (_[wn] = z), (W = wn);
        else break e;
      }
    }
    return P;
  ...
  function E(_, P) {
    (k = !1), x && ((x = !1), f(j), (j = -1)), (w = !0);
    var z = m;
    try {
      for (
        d(P), h = t(s);
        h !== null && (!(h.expirationTime > P) || (_ && !je()));
      ...
      if (h !== null) var er = !0;
        ...
        var yn = t(c);
        yn !== null && yl(g, yn.startTime - P), (er = !1);
      }
      return er;
    } finally {
      (h = null), (m = z), (w = !1);
      ...
      return (
        ...
        z > W
          ? ((_.sortIndex = z),
            ...
            t(s) === null &&
            _ === t(c) &&
            (x ? (f(j), (j = -1)) : (x = !0), yl(g, z - W)))
          : ((_.sortIndex = J), n(s, _), k || w || ((k = !0), gl(E))),
        _
      );
    }),
...
function bl(e, n) {
  ...
  n.hasOwnProperty("value")
    ? ei(e, n.type, t)
    : n.hasOwnProperty("defaultValue") && ei(e, n.type, pn(n.defaultValue)),
    n.checked == null &&
...
function $c(e, n, t, r, l, i, o, u, s) {
  (_t = !1), (Rr = null), Uc.apply(Ac, arguments);
}
...
function nf(e, n, t, r, l) {
  switch (n) {
    ...
    case "gotpointercapture":
      return (
        (i = l.pointerId), Ot.set(i, pt(Ot.get(i) || null, e, n, t, r, l)), !0
      );
  }
  return !1;
}
...
function xr(e) {
  ...
  for (var n = e.targetContainers; 0 < n.length;) {
    ...
    } else return (n = qt(t)), n !== null && qi(n), (e.blockedOn = t), !1;
    n.shift();
  }
  return !0;
}
...
function bi(e, n, t, r) {
  if (Or) {
    var l = fi(e, n, t, r);
    if (l === null) Fl(e, n, r, Dr, t), Yo(e, r);
...
var Dr = null;
function fi(e, n, t, r) {
  if (((Dr = null), (e = Gi(r)), (e = Sn(e)), e !== null))
...
var ut = {
  ...
  rl = Q({}, Zt, {
    ...
    movementX: function (e) {
      return "movementX" in e
        ...
        : (e !== ht &&
          (ht && e.type === "mousemove"
            ? ((Nl = e.screenX - ht.screenX), (jl = e.screenY - ht.screenY))
            : (jl = Nl = 0),
            (ht = e)),
          Nl);
    },
  ...
  Zo = ke(rl),
  uf = Q({}, rl, { dataTransfer: 0 }),
  sf = ke(uf),
  af = Q({}, Zt, { relatedTarget: 0 }),
  Pl = ke(af),
  cf = Q({}, ut, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  ff = ke(cf),
  df = Q({}, ut, {
...
var wf = Q({}, Zt, {
  ...
  Ef = ke(Sf),
  _f = Q({}, ut, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Cf = ke(_f),
  Nf = Q({}, rl, {
    deltaX: function (e) {
...
function Hs(e) {
  if (e.propertyName === "value" && ll(Ut)) {
    var n = [];
    As(n, Ut, e, Gi(e)), ks(If, n);
  }
}
function Ff(e, n, t) {
  e === "focusin"
    ? (lu(), (Nt = n), (Ut = t), Nt.attachEvent("onpropertychange", Hs))
    : e === "focusout" && lu();
}
function Of(e) {
  ...
  ks(function () {
    ...
    e: {
      ...
      if (m !== void 0) {
        ...
        for (var a = c, d; a !== null;) {
          ...
          if (
            (d.tag === 5 &&
              g !== null &&
              ((d = g),
                f !== null && ((g = Mt(a, f)), g != null && x.push(Ht(a, g, d)))),
              D)
          )
            break;
          a = a.return;
        ...
        0 < x.length &&
          ((m = new w(m, k, null, t, v)), h.push({ event: m, listeners: x }));
      }
    }
    if (!(n & 7)) {
      e: {
        ...
        if (
          ...
          if (
            ...
            n: {
              for (x = w, f = k, a = 0, d = x; d; d = Mn(d)) a++;
...
function gn() {
  if (!Dl && Qe !== null) {
    ...
    try {
      ...
      throw (Qe !== null && (Qe = Qe.slice(e + 1)), _s(Ji, gn), l);
    } finally {
      (I = n), (Dl = !1);
    }
  }
...
var Qn = [],
  ...
  Be = "";
function kn(e, n) {
  (Qn[Vn++] = Vr), (Qn[Vn++] = Qr), (Qr = e), (Vr = n);
}
function ea(e, n, t) {
  (xe[Se++] = Ve), (xe[Se++] = Be), (xe[Se++] = Pn), (Pn = e);
  var r = Ve;
  e = Be;
  var l = 32 - Re(r) - 1;
  (r &= ~(1 << l)), (t += 1);
...
function oo(e) {
  for (; e === Qr;)
    (Qr = Qn[--Vn]), (Qn[Vn] = null), (Vr = Qn[--Vn]), (Qn[Vn] = null);
  for (; e === Pn;)
    (Pn = xe[--Se]),
      (xe[Se] = null),
      (Be = xe[--Se]),
      ...
      return (
        (n =
          n.nodeType !== 1 || t.toLowerCase() !== n.nodeName.toLowerCase()
            ...
            : n),
        n !== null
          ? ((e.stateNode = n), (ge = e), (ve = sn(n.firstChild)), !0)
          : !1
      );
    case 6:
      return (
...
function pr(e) {
  ...
  } else ve = ge ? sn(e.stateNode.nextSibling) : null;
  return !0;
}
function ta() {
...
function ra(e) {
      ...
      : a !== null &&
        (a.elementType === E ||
          (typeof E == "object" &&
            ...
            E.$$typeof === qe &&
            yu(E) === a.type))
        ? ((g = l(a, d.props)), (g.ref = vt(f, a, d)), (g.return = f), g)
  ...
  function v(f, a, d, g, E) {
    return a === null || a.tag !== 7
      ? ((a = Nn(d, f.mode, g, E)), (a.return = f), a)
      : ((a = l(a, d)), (a.return = f), a);
  }
  function h(f, a, d) {
  ...
  function m(f, a, d, g) {
    ...
    if (typeof d == "object" && d !== null) {
      ...
      if (kt(d) || ft(d)) return E !== null ? null : v(f, a, d, g, null);
      mr(f, d);
    }
    return null;
  }
  function w(f, a, d, g, E) {
    ...
    if (typeof g == "object" && g !== null) {
      ...
      if (kt(g) || ft(g)) return (f = f.get(d) || null), v(a, f, g, E, null);
      mr(a, g);
    }
    return null;
  }
  function k(f, a, d, g) {
    for (
      var E = null, C = null, N = a, j = (a = 0), B = null;
      N !== null && j < d.length;
      j++
    ) {
    ...
    if (j === d.length) return t(f, N), A && kn(f, j), E;
    if (N === null) {
      for (; j < d.length; j++)
        (N = h(f, d[j], g)),
          N !== null &&
  ...
  function x(f, a, d, g) {
    ...
    for (
      var C = (E = null), N = a, j = (a = 0), B = null, T = d.next();
      N !== null && !T.done;
      j++, T = d.next()
    ) {
      N.index > j ? ((B = N), (N = null)) : (B = N.sibling);
    ...
    if (T.done) return t(f, N), A && kn(f, j), E;
    if (N === null) {
  ...
  function D(f, a, d, g) {
    if (
      ...
      switch (d.$$typeof) {
        case rr:
          e: {
            ...
            d.type === On
              ? ((a = Nn(d.props.children, f.mode, g, d.key)),
                (a.return = f),
                (f = a))
              : ((g = Lr(d.type, d.key, d.props, null, f.mode, g)),
                (g.ref = vt(f, a, d)),
      ...
      if (kt(d)) return k(f, a, d, g);
      if (ft(d)) return x(f, a, d, g);
      mr(f, d);
    }
...
function mo(e, n) {
  switch ((M(Bt, n), M(Vt, e), M($e, bt), (e = n.nodeType), e)) {
    case 9:
    case 11:
...
function Sa(e, n, t) {
  return zn & 21
    ? (Me(t, n) || ((t = js()), (H.lanes |= t), (Ln |= t), (e.baseState = !0)),
      n)
...
function rd(e, n, t) {
  ...
  if (_a(e)) Ca(n, l);
    ...
    (t = ia(e, n, l, r)),
      t !== null && ((l = ue()), Ie(t, e, r, l), Na(t, n, r));
  }
}
function _a(e) {
  var n = e.alternate;
  ...
  return (
    ...
    e !== null && !fe
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ge(e, n, l))
      : (A && t && io(n), (n.flags |= 1), oe(e, n, r, l), n.child)
  );
}
  ...
  return (
    ...
    e !== null && !fe
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ge(e, n, l))
      : (A && r && io(n), (n.flags |= 1), oe(e, n, t, l), n.child)
  );
}
function Lu(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    jr(e, n), ja(n, t, r), _i(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      u = n.memoizedProps;
    o.props = u;
...
function ji(e, n, t, r, l, i) {
  Ra(e, n);
  var o = (n.flags & 128) !== 0;
  if (!r && !o) return l && hu(n, t, !1), Ge(e, n, i);
...
function Tu(e, n, t, r, l) {
  return nt(), uo(l), (n.flags |= 256), oe(e, n, t, r), n.child;
}
...
function ad(e, n, t, r, l, i, o) {
  if (t)
    return n.flags & 256
      ? ((n.flags &= -257), (r = Ql(Error(y(422)))), hr(e, n, o, r))
      : n.memoizedState !== null
  ...
  if (l.data === "$!") {
    ...
    return (r = u), (i = Error(y(419))), (r = Ql(i, r, void 0)), hr(e, n, o, r);
  }
  if (((u = (o & e.childLanes) !== 0), fe || u)) {
    ...
    return Po(), (r = Ql(Error(y(421)))), hr(e, n, o, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
  ...
  switch ((oo(n), n.tag)) {
    ...
    case 5:
      ...
      if (((t = n.type), e !== null && n.stateNode != null))
        ...
        if (((e = _n($e.current)), pr(n))) {
          ...
          switch (((r[Ue] = n), (r[Qt] = i), (e = (n.mode & 1) !== 0), t)) {
            case "dialog":
    ...
    case 6:
      if (e && n.stateNode != null) Ua(e, n, e.memoizedProps, r);
        ...
        if (((t = _n(Bt.current)), _n($e.current), pr(n))) {
          if (
            ((r = n.stateNode),
              (t = n.memoizedProps),
              (r[Ue] = n),
    ...
    case 4:
      return (
        rt(), Li(e, n), e === null && $t(n.stateNode.containerInfo), re(n), null
      );
    case 10:
    ...
    case 17:
      return pe(n.type) && $r(), re(n), null;
    case 19:
      if ((O($), (i = n.memoizedState), i === null)) return re(n), null;
...
function dd(e, n) {
  switch ((oo(n), n.tag)) {
    ...
    case 5:
      return ho(n), null;
    case 13:
      if ((O($), (e = n.memoizedState), e !== null && e.dehydrated !== null)) {
...
function md(e, n) {
  ...
  for (hi = { focusedElem: e, selectionRange: t }, Or = !1, S = n; S !== null;)
...
function Aa(e) {
  ...
  n !== null && ((e.alternate = null), Aa(n)),
    ...
    ((n = e.stateNode),
      n !== null &&
      (delete n[Ue], delete n[Qt], delete n[yi], delete n[Jf], delete n[Zf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ie(e, n, t, r) {
  if (50 < Tt) throw ((Tt = 0), (Oi = null), Error(y(185)));
  Jt(e, t, r),
    (!(R & 2) || e !== q) &&
    (e === q && (!(R & 2) && (fl |= t), G === 4 && nn(e, ee)),
      me(e, r),
      t === 1 && R === 0 && !(n.mode & 1) && ((it = K() + 500), ul && gn()));
}
function me(e, n) {
...
function Ba(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = br(e, r);
    ...
    R |= 2;
    var i = Ka();
    (q !== e || ee !== n) && ((He = null), (it = K() + 500), Cn(e, n));
    do
      try {
        wd();
        break;
    ...
    ao(),
      (Jr.current = i),
      (R = l),
      X !== null ? (n = 0) : ((q = null), (ee = 0), (n = G));
  }
  if (n !== 0) {
    if (
      (n === 2 && ((l = ai(e)), l !== 0 && ((r = l), (n = Di(e, l)))), n === 1)
    )
      throw ((t = Yt), Cn(e, 0), nn(e, r), me(e, K()), t);
    if (n === 6) nn(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (nn(e, r), (r & 130023424) === r && ((n = Co + 500 - K()), 10 < n))
          ) {
            if (Fr(e, 0) !== 0) break;
  ...
  return me(e, K()), e.callbackNode === t ? Ba.bind(null, e) : null;
}
function Di(e, n) {
  var t = Lt;
  return (
...
function Au(e) {
  ...
  if (t === 1) throw ((t = Yt), Cn(e, 0), nn(e, n), me(e, K()), t);
...
function Tn(e) {
  ...
  try {
    ...
    (I = r), (_e.transition = t), (R = n), !(R & 6) && gn();
  }
}
function jo() {
  (he = Kn.current), O(Kn);
...
function br(e, n) {
  ...
  while (!0);
  if ((ao(), (R = t), (Jr.current = r), X !== null)) throw Error(y(261));
...
function xn(e, n, t) {
  var r = I,
    l = _e.transition;
  try {
    (_e.transition = null), (I = 1), kd(e, n, t, r);
  } finally {
    (_e.transition = l), (I = r);
  }
  return null;
...
function kd(e, n, t, r) {
  ...
  if (Zr) throw ((Zr = !1), (e = Fi), (Fi = null), e);
  return (
    qr & 1 && e.tag !== 0 && qn(),
    (i = e.pendingLanes),
    i & 1 ? (e === Oi ? Tt++ : ((Tt = 0), (Oi = e))) : (Tt = 0),
    gn(),
    null
  );
}
function qn() {
  if (rn !== null) {
    var e = Ps(qr),
      ...
      t = I;
    try {
      if (((_e.transition = null), (I = 16 > e ? 16 : e), rn === null))
        var r = !1;
      else {
        ...
        if (
          ((R = l), gn(), Ae && typeof Ae.onPostCommitFiberRoot == "function")
        )
          try {
...
function xd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    q === e &&
    (ee & t) === t &&
    (G === 4 || (G === 3 && (ee & 130023424) === ee && 500 > K() - Co)
      ? Cn(e, 0)
      : (_o |= t)),
    me(e, n);
}
...
Ja = function (e, n, t) {
  ...
  else (fe = !1), A && n.flags & 1048576 && ea(n, Vr, n.index);
      ...
      return (
        ...
        typeof l == "object" &&
          ...
          ? ((n.tag = 1),
            ...
            _i(n, r, e, t),
            (n = ji(null, n, r, !0, i, t)))
          : ((n.tag = 0), A && i && io(n), oe(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Zi(n, t | 1), me(n, K()), !(R & 6) && ((it = K() + 500), gn()));
      }
      break;
    case 13:
      Tn(function () {
...
ys = No;
ws = Tn;
var Ld = { usingClientEntryPoint: !1, Events: [qt, $n, ol, vs, gs, No] },
  yt = {
...
function Oe({
  ...
  return p.jsxs("div", {
    ...
    style: { left: t, top: r, ...o },
    ...c,
    children: [
      p.jsx("img", {
        className: "absolute",
        style: { minWidth: l, minHeight: i, transform: `translate(${u},${s})` },
        src: e,
        alt: "main",
        onMouseEnter: m,
        onMouseLeave: w,
        ...
        children: [
          ...
          p.jsxs("div", {
            ...
            children: [
              p.jsxs("div", {
                className:
                  "absolute left-0 top-0 w-[1920px] -translate-y-[340px] hover:translate-y-0 transition-transform z-10 cursor-default",
                children: [
                  p.jsx("img", {
                  ...
                  p.jsxs("div", {
                    className:
                      "absolute left-1/2 top-1/2 flex flex-col items-center gap-4 text-[#FFCC00]",
                    style: { transform: "translate(-50%, -63%)" },
                    children: [
                      p.jsxs("div", {
                        className: "flex items-center gap-4 text-[70px]",
                        children: [
                          p.jsx("span", { children: "Tract price here:" }),
                          p.jsxs("div", {
                            className: "flex items-center gap-2",
                            children: [p.jsx("a", {
                              href: "https://dextools.io/app/en/token/0xComingSoon",
                              target: "_blank",
                              rel: "noreferrer",
              ...
              p.jsx("a", {
                ...
                children: p.jsx(Oe, {
                  ...
                  width: 114,
                  height: 150,
                  style: { animation: "1s linear 0s shake3 infinite" },
                }),
              }),
              p.jsx(Oe, {
              ...
              p.jsxs("div", {
                ...
                ref: n,
                className:
                  "absolute cursor-default min-w-[900px] text-[#FFCC00] text-[31px] leading-[1.2] pt-[110px]",
                style: { left: 860, top: 1300 },
                children: [
                  p.jsx("div", {
                    className:
                      "text-[70px] mb-[45px] leading-none drop-shadow-[1px_1px_0px_#FFCC00]",
                    children: "About Us",
                  }),
                  p.jsxs("div", {
                    children: [
                      "Once upon a time, in an era when humans began to realize their true power lay in their brains, great talents were celebrated like rock stars. And guess what? I was one of those divine rock stars, gifted by the gods themselves.",
                      p.jsx("br", {}),
                      p.jsx("br", {}),
                      "Fast forward to today, and it's like a circus out here. Too much noise, too many distractions, and truth? It's hiding somewhere, probably playing hide and seek. Justice? Oh, it's doing a great job losing followers among the brainwashed masses.",
                      p.jsx("br", {}),
                      p.jsx("br", {}),
                      "But then, I felt the itch. An itch to shake things up, to break through the noise and nonsense. It was time to wake people up and show them what true justice looks like—with a dash of flair and a whole lot of sass.",
                    ],
                  }),
                ],
              }),
              p.jsxs("div", {
                ...
                style: { left: 385, top: 2336 },
                children: [
                  p.jsx("div", {
                    className:
                      "text-[#FFCC00] text-[80px] mb-[70px] leading-none drop-shadow-[1px_1px_0px_#FFCC00]",
                    children: "Tokenomics",
                  }),
                  p.jsxs("div", {
                    className:
                      "text-[#770000] text-[50px] italic min-w-max leading-[1.8] drop-shadow-[1px_1px_0px_#770000] uppercase",
                    children: [
                      p.jsx("p", { children: "Total supply: 100 Million" }),
                      p.jsx("p", {
                        className: "-ml-[17px]",
                        children: "Contract is renounced",
                      }),
                      p.jsx("p", {
                        className: "-ml-[34px]",
              ...
              p.jsx("div", {
                ...
                style: { left: 0, top: 3350 },
              }),
              p.jsx("div", {
                id: "footer",
                className: "absolute cursor-default min-w-max",
                style: { left: 960, top: 4570, transform: "translateX(-50%)" },
                children: p.jsxs("div", {
                  className: "flex flex-col items-center gap-5",
                  children: [
                    p.jsxs("div", {
                      className:
                        "flex items-center gap-3 uppercase text-[#FFCC00] text-[56px]",
                      children: [
                        p.jsx("span", {
                    ...
                    p.jsx("span", {
                      ...
                      children:
                        "The information provided on this website is for informational purposes only and should not be considered financial advice. Investing in $SCREAM or any cryptocurrency involves risks. The value of cryptocurrencies can be volatile and may result in financial loss. Please conduct your own research and make informed investment decisions. We are not responsible for any losses incurred.",
                    }),
                  ],
                }),
              }),
        ...
        children: [
          ...
          p.jsxs("div", {
            ...
            children: [
              p.jsxs("div", {
                className:
                  "absolute h-7 w-[432px] flex justify-center items-center gap-4 home_mobile_menu_bar uppercase text-[#FFCC00]",
                style: { left: 0, top: 142 },
                children: [
                  p.jsx("span", {
              ...
              p.jsxs("div", {
                ...
                ref: n,
                className:
                  "absolute cursor-default w-[370px] text-[#FFCC00] text-[18px] leading-[1.2] text-center pt-[30px]",
                style: { left: 30, top: 1310 },
                children: [
                  "Once upon a time, in an era when humans began to realize their true power lay in their brains, great talents were celebrated like rock stars. And guess what? I was one of those divine rock stars, gifted by the gods themselves.",
                  p.jsx("br", {}),
                  p.jsx("br", {}),
              ...
              p.jsxs("div", {
                ...
                style: { left: 47, top: 1910 },
                children: [
                  p.jsx("div", {
                    className:
                      "text-[#FFCC00] text-[20px] mb-[14px] leading-none",
                    children: "Tokenomics",
                  }),
                  p.jsxs("div", {
                    className:
                      "text-[#770000] text-[15px] italic min-w-max leading-[1.8] drop-shadow-[0px_0px_0px_#770000]",
                    children: [
                      p.jsx("p", {
                        className: "ml-[2px]",
                        children: "Total supply: 100 Million",
                      }),
                      p.jsx("p", {
                        className: "-ml-[4px]",
                        children: "Contract is renounced",
              ...
              p.jsx("div", {
                id: "footer",
                className: "absolute cursor-default min-w-max",
                style: { left: 216, top: 2525, transform: "translateX(-50%)" },
                children: p.jsxs("div", {
                  className: "flex flex-col items-center",
                  children: [
                    p.jsxs("div", {
                      className:
                        "flex items-center gap-2 uppercase text-[#FFCC00] text-[18px]",
                      children: [
                        p.jsx("span", {
                    ...
                    p.jsxs("span", {
                      className:
                        "text-[13px] max-w-[392px] text-center leading-none",
                      children: [
                        "The information provided on this website is for informa-",
                        p.jsx("br", {}),
                        "tional purposes only and should not be considered",
                        p.jsx("br", {}),
                        "financial advice. Investing in $SCREAM or any cryptocur-",
                        p.jsx("br", {}),
                        "rency involves risks. The value of cryptocurrencies can be",
                        p.jsx("br", {}),
                        "volatile and may result in financial loss. Please conduct",
                        p.jsx("br", {}),
                        "your own research and make informed",
                        p.jsx("br", {}),
              ...
              p.jsxs("div", {
                ...
                style: { left: 216, top: 2720, transform: "translateX(-50%)" },
                children: [
                  p.jsx("a", {
                    href: "https://x.com/Scream_ByMF",
                    target: "_blank",
                  ...
                  p.jsx("a", {
                    ...
                    className: "w-10 h-10",
                    children: p.jsx("img", {
                      src: "/images/social/SOLSCAN.gif",
                      loading: "eager",
                      alt: "solscan",
                    }),
                  }),
                  p.jsx("a", {
                    href: "https://drive.google.com/file/d/16t3-oZsP1xjHU8aOEMAsNavPSsD6QtI8/view?usp=sharing",
                    target: "_blank",
                    rel: "noreferrer",
                    className: "w-10 h-10",
                    children: p.jsx("img", {
                      src: "/images/social/WHITEPAPER.gif",
                      loading: "eager",
                      alt: "whitepaper",
                    }),
                  }),
                  ...
                  p.jsx("a", {
                    href: "https://www.geckoterminal.com/solana/pools/FrEt44JgwU7QNnz1UiQjmhMJgPAyYMDQ4zHz5LxCCwwy",
                    target: "_blank",
                    rel: "noreferrer",
                    className: "w-10 h-10 p-[3px]",
                    children: p.jsx("img", {
...
function Od() {
  return p.jsx(p.Fragment, { children: p.jsx(Fd, {}) });
}
Kl.createRoot(document.getElementById("root")).render(
  p.jsx(kc.StrictMode, { children: p.jsx(Od, {}) })
);
